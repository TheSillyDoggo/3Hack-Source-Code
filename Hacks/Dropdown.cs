...
namespace ModuleType
{
    public class Dropdown : Module
    {
        ...
        public override void Draw(Rect rect, Window wnd)
        {
            ...
            DrawUtils.DrawText(rec, text, Color.white);
            ...
            if (Event.current.type == EventType.MouseDown)
            {
                //i have no fucking clue why but even when factoring in the mouse x < pos you can still activate it from the left
                //this is really angering me so this is an *intended feature* now
